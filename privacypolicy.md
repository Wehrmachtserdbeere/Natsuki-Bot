...
**Data Controller:** Strawberry Software  
**Contact:** [Support Server](https://discord.gg/9EAGVZUt2Y)  
...
- To enable bot commands and functionalities.  
- To maintain and improve bot performance.  
- To ensure and enforce compliance with our Terms of Use and Discord’s policies.  
...
To exercise these rights, please contact us in our [Support Server](https://discord.gg/9EAGVZUt2Y). If your request relates to data processed by Discord, please refer to [Discord’s Privacy Policy](https://discord.com/privacy).  

## **9. Data Retention**  

We retain necessary data for as long as required for bot functionality and compliance with Discord’s policies. Messages and command inputs are processed in real time and are not stored.  

- **User IDs of blacklisted users** are stored indefinitely unless a removal request is granted.  
- When other data is no longer needed, we securely delete it.  
...
For any privacy-related inquiries, please contact us via our [Support Server](https://discord.gg/9EAGVZUt2Y).  
